...
2. **Stage 2 — State Authority:** **soft-shadow closed** (Goals A; Memory 4a–4c; Workflows 5a+5b execution-scoped; Executions 6a+6b; Agents ADR-013). **R1 P4:** inspector rail composed (World/Graph → InspectorDock); timeline residual next. Gated: SA mutate non-WM (ADR); Goose = Stage 3; Async EventBus = Phase 5 + approval.
