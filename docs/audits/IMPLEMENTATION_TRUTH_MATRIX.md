...
| StateAuthorityService | ✅ | ✅ | State projection before plan; WM mutate | **keep** — deepen per contract (P3) |
| SingleGoalScheduler | ✅ | ✅ | Goal queue → `EXECUTION_RUN_REQUEST` | **keep** — live goals SoT |
