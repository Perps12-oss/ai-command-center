...
| **B** — Autonomy | ACCEPT numeric bands + block-vs-escalate | **ACCEPT** — escalate-only, bands `<0.4` HIGH / `0.4–0.7` MEDIUM / `≥0.7` LOW; low score never independently blocks | [`ADR-022` §11](../adr/ADR-022_CONFIDENCE_AND_AUTONOMY.md#11-gate-2-addendum--wave-1-closure-2026-08-14) | Gate 3 Section 9 plan authorized next |
