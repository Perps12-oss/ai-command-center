...
`PROJECT_CONSTITUTION_V4.md` → `AGENTS.md` → `docs/UI_CONSTITUTION.md` → this skill.

ACC's product shell is CustomTkinter. Use Hallmark for greenfield HTML/CSS
artifacts or explicit visual audits — not to replace ACC ownership
(`UI → AppState → EventBus → Services`) or to restyle the app unasked.
